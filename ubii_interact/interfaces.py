...
from proto import DeviceList, Device, Server, Client, Session
...
class IServiceProvider(ABC):
    @abstractmethod
    async def server_config(self, **message) -> proto.Server: ...
    @abstractmethod
    async def client_registration(self, **message) -> proto.Client: ...
    @abstractmethod
    async def client_deregistration(self, **message) -> proto.Success: ...
    @abstractmethod
    async def client_get_list(self, **message) -> proto.ClientList: ...
    @abstractmethod
    async def device_registration(self, **message) -> proto.Device: ...
    @abstractmethod
    async def device_deregistration(self, **message) -> proto.Success: ...
    @abstractmethod
